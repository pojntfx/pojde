...
rm /root/Repos/felicitas-pojtingers-theia/plugins/omnisharp_theia_plugin.vsix-extracted/.omnisharp/bin/mono
ln -s $(which mono) /root/Repos/felicitas-pojtingers-theia/plugins/omnisharp_theia_plugin.vsix-extracted/.omnisharp/bin/mono
