...
available_modules=(
    ...
    lang.dotnet .NET $(${POJDE_NG_MODULE_DOTNET_ENABLED} && echo on || echo off)
...
echo export "'"POJDE_NG_MODULE_DOTNET_ENABLED=$([[ "$selected_modules" == *"lang.dotnet"* ]] && echo true || echo false)"'" >>${TMP_PREFERENCE_FILE}
