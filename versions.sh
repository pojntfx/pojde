...
export CODE_SERVER_VERSION="3.10.2"                 # https://github.com/cdr/code-server/releases
...
export GO_VERSION="1.16.4"                          # https://golang.org/dl/
export TINYGO_VERSION="0.18.0"                      # https://github.com/tinygo-org/tinygo/releases
...
export OCTAVE_DEBUGGER_VERSION="0.4.15"             # https://marketplace.visualstudio.com/items?itemName=paulosilva.vsc-octave-debugger
