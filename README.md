...
2. Run `curl -o /etc/theia/packages.txt https://raw.githubusercontent.com/pojntfx/felix-pojtingers-theia/master/packages.txt` to download the list of the required packages
3. Run `curl -o /etc/theia/repositories.txt https://raw.githubusercontent.com/pojntfx/felix-pojtingers-theia/master/repositories.txt` to download the recommended repositories
4. Run `curl -o /etc/theia/setup.sh https://raw.githubusercontent.com/pojntfx/felix-pojtingers-theia/master/setup.sh` to download the installation script
